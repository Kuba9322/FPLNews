...
import static pl.sturnusdev.fantasypremierleaguenews.storage.MultipartFileUtil.convertByteArrayToMultipartFile;
...
public class FileStorageService {
    ...
    public String saveImage(byte[] file) {
        MultipartFile multipartFile = convertByteArrayToMultipartFile(file, "s", "s");
        //add file verification
        return saveFile(multipartFile, imageStorageLocation);
    }
